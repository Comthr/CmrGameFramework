...
namespace CmrGame
{
    ...
    {
        public EventComponent Event => GameEntry.Event;
        ...
        {
            //string tableName = $"{Constant.Global.MainNamespace}.{E_DataTable.TestTable}";
            //string dataTableAssetName = Constant.Asset.GetGlobalDataTableAsset(tableName);
        ...
        {            
            ...
            //string dictionaryAssetName = AssetUtility.GetDictionaryAsset(dictionaryName, false, GameEntry.Localization.Language);
