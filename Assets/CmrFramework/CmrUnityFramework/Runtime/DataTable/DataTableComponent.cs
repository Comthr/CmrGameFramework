...
namespace CmrUnityGameFramework.Runtime
{
    ...
    [AddComponentMenu("CmrFramework/Data Table")]
    public sealed class DataTableComponent : GameFrameworkComponent
    {
        ...
        {
            //CYJALTER:在我的规划里，一定是有名字的。
            //类型和名字也一定相同，不存在只有类型没有名字的DataTable
            return m_DataTableManager.GetDataTable<T>(typeof(T).ToString());
        }
