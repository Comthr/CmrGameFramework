...
namespace CmrUnityFramework.Runtime
{
    ...
    public sealed class Entity : MonoBehaviour, IEntity
    {
        ...
        public void OnInit(int entityId, string entityAssetName, IEntityGroup entityGroup, bool isNewInstance, object userData)
        {
            ...
            {
                Log.Error($"Entity '[{m_Id}]{m_EntityAssetName}' OnInit with exception '{exception}'.");
            }
        }
        ...
        public void OnRecycle()
        {
            ...
            {
                Log.Error($"Entity '[{m_Id}]{m_EntityAssetName}' OnRecycle with exception '{exception}'.");
            }
        ...
        public void OnShow(object userData)
        {
            ...
            {
                Log.Error($"Entity '[{m_Id}]{m_EntityAssetName}' OnShow with exception '{exception}'.");
            }
        }
        ...
        public void OnHide(bool isShutdown, object userData)
        {
            ...
            {
                Log.Error($"Entity '[{m_Id}]{m_EntityAssetName}' OnHide with exception '{exception}'.");
            }
        }
        ...
        public void OnAttached(IEntity childEntity, object userData)
        {
            ...
            {
                Log.Error($"Entity '[{m_Id}]{m_EntityAssetName}' OnAttached with exception '{exception}'.");
            }
        }
        ...
        public void OnDetached(IEntity childEntity, object userData)
        {
            ...
            {
                Log.Error($"Entity '[{m_Id}]{m_EntityAssetName}' OnDetached with exception '{exception}'.");
            }
        }
        ...
        public void OnAttachTo(IEntity parentEntity, object userData)
        {
            ...
            {
                Log.Error($"Entity '[{m_Id}]{m_EntityAssetName}' OnAttachTo with exception '{exception}'.");
            }
        ...
        public void OnDetachFrom(IEntity parentEntity, object userData)
        {
            ...
            {
                Log.Error($"Entity '[{m_Id}]{m_EntityAssetName}' OnDetachFrom with exception '{exception}'.");
            }
        }
        ...
        public void OnUpdate(float elapseSeconds, float realElapseSeconds)
        {
            ...
            {
                Log.Error($"Entity '[{m_Id}]{m_EntityAssetName}' OnUpdate with exception '{exception}'.");
            }
        }
    }
}
