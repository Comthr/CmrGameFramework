...
using CmrGameFramework.WebRequest;
...
namespace CmrUnityGameFramework.Runtime
{
    ...
    [AddComponentMenu("CmrFramework/Web Request")]
    public sealed class WebRequestComponent : GameFrameworkComponent
    {
        ...
        private void OnWebRequestStart(object sender, CmrGameFramework.WebRequest.WebRequestStartEventArgs e)
        {
            m_EventComponent.Fire(this, WebRequestStartEventArgs.Create(e));
        }

        private void OnWebRequestSuccess(object sender, CmrGameFramework.WebRequest.WebRequestSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, WebRequestSuccessEventArgs.Create(e));
        }

        private void OnWebRequestFailure(object sender, CmrGameFramework.WebRequest.WebRequestFailureEventArgs e)
        {
