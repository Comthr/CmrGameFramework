...
namespace CmrUnityFramework.Runtime
{
    ...
    [AddComponentMenu("CmrFramework/UI")]
    public sealed partial class UIComponent : GameFrameworkComponent
    {
        ...
        private void OnOpenUIFormSuccess(object sender, CmrGameFramework.UI.OpenUIFormSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, OpenUIFormSuccessEventArgs.Create(e));
        }

        private void OnOpenUIFormFailure(object sender, CmrGameFramework.UI.OpenUIFormFailureEventArgs e)
        {
            Log.Warning($"Open UI form failure, asset name '{e.UIFormAssetName}', UI group name '{e.UIGroupName}'," +
                $" pause covered UI form '{e.PauseCoveredUIForm}', error message '{e.ErrorMessage}'.");
            if (m_EnableOpenUIFormFailureEvent)
                m_EventComponent.Fire(this, OpenUIFormFailureEventArgs.Create(e));
        }

        private void OnOpenUIFormUpdate(object sender, CmrGameFramework.UI.OpenUIFormUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, OpenUIFormUpdateEventArgs.Create(e));
        }

        private void OnOpenUIFormDependencyAsset(object sender, CmrGameFramework.UI.OpenUIFormDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(this, OpenUIFormDependencyAssetEventArgs.Create(e));
        }

        private void OnCloseUIFormComplete(object sender, CmrGameFramework.UI.CloseUIFormCompleteEventArgs e)
        {
