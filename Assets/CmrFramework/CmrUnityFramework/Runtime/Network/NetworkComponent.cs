...
namespace CmrUnityFramework.Runtime
{
    ...
    [AddComponentMenu("CmrFramework/Network")]
    public sealed class NetworkComponent : GameFrameworkComponent
    {
        ...
        private void OnNetworkConnected(object sender, CmrGameFramework.Network.NetworkConnectedEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkConnectedEventArgs.Create(e));
        }

        private void OnNetworkClosed(object sender, CmrGameFramework.Network.NetworkClosedEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkClosedEventArgs.Create(e));
        }

        private void OnNetworkMissHeartBeat(object sender, CmrGameFramework.Network.NetworkMissHeartBeatEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkMissHeartBeatEventArgs.Create(e));
        }

        private void OnNetworkError(object sender, CmrGameFramework.Network.NetworkErrorEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkErrorEventArgs.Create(e));
        }

        private void OnNetworkCustomError(object sender, CmrGameFramework.Network.NetworkCustomErrorEventArgs e)
        {
