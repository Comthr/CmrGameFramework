            ...
            protected override void OnDrawScrollableWindow()
            {
                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    else
                    {
                        ...
                        {
                            GUILayout.Label($"<b>{m_Samples.Count} {typeName}s ({GetByteLengthString(m_SampleSize)}) obtained at {m_SampleTime.ToLocalTime():yyyy-MM-dd HH:mm:ss}, while {m_DuplicateSimpleCount} {typeName}s ({GetByteLengthString(m_DuplicateSampleSize)}) might be duplicated.</b>");
                        }
                        else
                        {
                            GUILayout.Label($"<b>{m_Samples.Count} {typeName}s ({GetByteLengthString(m_SampleSize)}) obtained at {m_SampleTime.ToLocalTime():yyyy-MM-dd HH:mm:ss}.</b>");
                        }
