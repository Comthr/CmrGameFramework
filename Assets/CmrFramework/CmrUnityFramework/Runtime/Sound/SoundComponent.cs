...
namespace CmrUnityFramework.Runtime
{
    ...
    [AddComponentMenu("CmrFramework/Sound")]
    public sealed partial class SoundComponent : GameFrameworkComponent
    {
        ...
        private void OnPlaySoundSuccess(object sender, CmrGameFramework.Sound.PlaySoundSuccessEventArgs e)
        {
        ...
        private void OnPlaySoundFailure(object sender, CmrGameFramework.Sound.PlaySoundFailureEventArgs e)
        {
        ...
        private void OnPlaySoundUpdate(object sender, CmrGameFramework.Sound.PlaySoundUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, PlaySoundUpdateEventArgs.Create(e));
        }

        private void OnPlaySoundDependencyAsset(object sender, CmrGameFramework.Sound.PlaySoundDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(this, PlaySoundDependencyAssetEventArgs.Create(e));
        }

        private void OnLoadSceneSuccess(object sender, CmrGameFramework.Scene.LoadSceneSuccessEventArgs e)
        {
            RefreshAudioListener();
        }

        private void OnLoadSceneFailure(object sender, CmrGameFramework.Scene.LoadSceneFailureEventArgs e)
        {
            RefreshAudioListener();
        }

        private void OnUnloadSceneSuccess(object sender, CmrGameFramework.Scene.UnloadSceneSuccessEventArgs e)
        {
            RefreshAudioListener();
        }

        private void OnUnloadSceneFailure(object sender, CmrGameFramework.Scene.UnloadSceneFailureEventArgs e)
        {
            RefreshAudioListener();
        }
