...
namespace CmrUnityGameFramework.Editor
{
    ...
    internal sealed class ResourceComponentInspector : GameFrameworkInspector
    {
                            ...
                            if (GUILayout.Button("Export CSV Data"))
                            {
                                ...
                                if (!string.IsNullOrEmpty(exportFileName))
                                {
                                    try
                                    {
                                        ...
                                        foreach (TaskInfo loadAssetInfo in loadAssetInfos)
                                        {
                                            data[index++] = $"{loadAssetInfo.Description},{loadAssetInfo.SerialId},{loadAssetInfo.Priority},{loadAssetInfo.Status}";
                                        }
        ...
        {
            EditorGUILayout.LabelField(loadAssetInfo.Description, $"[SerialId]{loadAssetInfo.SerialId} [Priority]{loadAssetInfo.Priority} [Status]{loadAssetInfo.Status}");
        }
