    ...
    internal sealed class BaseComponentInspector : GameFrameworkInspector
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlayingOrWillChangePlaymode);
            {
                ...
                {
                    EditorGUILayout.HelpBox("Editor resource mode option is only for editor mode. CmrFramework will use editor resource files, which you should validate first.", MessageType.Warning);
