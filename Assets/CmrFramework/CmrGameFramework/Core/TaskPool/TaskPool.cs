...
namespace CmrGameFramework
{
    ...
    internal sealed class TaskPool<T> where T : TaskBase
    {
        ...
        private readonly CachedLinkList<ITaskAgent<T>> m_WorkingAgents;
        private readonly CachedLinkList<T> m_WaitingTasks;
        ...
        public TaskPool()
        {
            ...
            m_WorkingAgents = new CachedLinkList<ITaskAgent<T>>();
            m_WaitingTasks = new CachedLinkList<T>();
            m_Paused = false;
        }
        ...
        {
            if (agent == null)
                throw Utility.Exception.ThrowException("Task agent is invalid.");
