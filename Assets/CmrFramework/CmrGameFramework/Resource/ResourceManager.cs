...
namespace CmrGameFramework.Resource
{
    /// <summary>
    /// 资源管理器。
    /// </summary>
    internal sealed partial class ResourceManager : GameFrameworkModule, IResourceManager
    {
        ...
        private string m_ReadOnlyPath;//CYJ:就是StreamingAssetsPath
        ...
        public void SetReadOnlyPath(string readOnlyPath)
        {
            if (string.IsNullOrEmpty(readOnlyPath))
                throw Utility.Exception.ThrowException("Read-only path is invalid.");

            if (m_RefuseSetFlag)
                throw Utility.Exception.ThrowException("You can not set read-only path at this time.");

            if (m_ResourceLoader.TotalAgentCount > 0)
                throw Utility.Exception.ThrowException("You must set read-only path before add load resource agent helper.");
        ...
        public void SetResourceMode(ResourceMode resourceMode)
        {
            ...
            if (m_ResourceMode == ResourceMode.Unspecified)
            {
                ...
                throw Utility.Exception.ThrowException("You can not change resource mode at this time.");
        }
        ...
        {
            if (m_RefuseSetFlag)
                throw Utility.Exception.ThrowException("You can not set current variant at this time.");
        ...
        public void SetObjectPoolManager(IObjectPoolManager objectPoolManager)
        {
            if (objectPoolManager == null)
                throw Utility.Exception.ThrowException("Object pool manager is invalid.");
        ...
        public void InitResources(InitResourcesCompleteCallback initResourcesCompleteCallback)
        {
            if (initResourcesCompleteCallback == null)
                throw Utility.Exception.ThrowException("Init resources complete callback is invalid.");

            if (m_ResourceMode == ResourceMode.Unspecified)
                throw Utility.Exception.ThrowException("You must set resource mode first.");

            if (m_ResourceMode != ResourceMode.Package)
                throw Utility.Exception.ThrowException("You can not use InitResources without package resource mode.");

            if (m_ResourceIniter == null)
                throw Utility.Exception.ThrowException("You can not use InitResources at this time.");
        ...
        public HasAssetResult HasAsset(string assetName)
        {
            if (string.IsNullOrEmpty(assetName))
                throw Utility.Exception.ThrowException("Asset name is invalid.");
        ...
        public void LoadAsset(string assetName, LoadAssetCallbacks loadAssetCallbacks)
        {
            ...
            if (loadAssetCallbacks == null)
                throw Utility.Exception.ThrowException("Load asset callbacks is invalid.");
