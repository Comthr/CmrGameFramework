        ...
        private sealed partial class UIGroup : IUIGroup
        {
            ...
            public void RemoveUIForm(IUIForm uiForm)
            {
                ...
                if (!m_UIFormInfos.Remove(uiFormInfo))
                    throw Utility.Exception.ThrowException($"UI group '{m_Name}' not exists specified UI form '[{uiForm.SerialId}]{uiForm.UIFormAssetName}'.");
