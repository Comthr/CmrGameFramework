...
using System;
namespace CmrGameFramework.Procedure
{
    internal sealed class ProcedureManager : GameFrameworkModule, IProcedureManager
    {
        ...
        public ProcedureBase CurrentProcedure
        {
            get
            {
                if (m_ProcedureFsm == null)
                    throw Utility.Exception.ThrowException("You must initialize procedure first.");
        ...
        public void Initialize(IFsmManager fsmManager, params ProcedureBase[] procedures)
        {
            ...
            if (fsmManager == null)
                throw Utility.Exception.ThrowException("FSM manager is invalid.");
        ...
        {
            if (m_ProcedureFsm == null)
                Utility.Exception.ThrowException("You must initialize procedure first.");
