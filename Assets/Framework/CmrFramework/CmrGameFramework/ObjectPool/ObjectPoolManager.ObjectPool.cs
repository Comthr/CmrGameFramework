...
namespace CmrGameFramework.ObjectPool
{
    internal sealed partial class ObjectPoolManager : GameFrameworkModule, IObjectPoolManager
    {
        ...
        private sealed class ObjectPool<T> : ObjectPoolBase, IObjectPool<T> where T : ObjectBase
        {
            ...
            public override int Capacity
            {
                ...
                {
                    if (value < 0)
                        throw Utility.Exception.ThrowException("Capacity is invalid.");
            ...
            public override float ExpireTime
            {
                ...
                {
                    if (value < 0f)
                        throw Utility.Exception.ThrowException("ExpireTime is invalid.");
            ...
            {
                if (obj == null)
                    throw Utility.Exception.ThrowException("Object is invalid.");
            ...
            {
                if (name == null)
                    throw Utility.Exception.ThrowException("Name is invalid.");
            ...
            public T Spawn(string name)
            {
                ...
                LinkedListRange<Object<T>> objectRange = default;
                if (m_Objects.TryGetValue(name, out objectRange))
                {
                    foreach (Object<T> internalObject in objectRange)
                    {
            ...
            {
                if (target == null)
                    throw Utility.Exception.ThrowException("Target is invalid.");
                ...
                if (internalObject != null)
                {
                    ...
                    throw Utility.Exception.ThrowException($"Can not find target in object pool '{new TypeNamePair(typeof(T), Name)}', target type is '{target.GetType().FullName}', target value is '{target}'.");
            }
            ...
            public void Release(int toReleaseCount, ReleaseObjectFilterCallback<T> releaseObjectFilterCallback)
            {
                if (releaseObjectFilterCallback == null)
                    throw Utility.Exception.ThrowException("Release object filter callback is invalid.");
