...
namespace CmrUnityFramework.Editor.ResourceTools
{
    public sealed partial class ResourceBuilderController
    {
        ...
        public string GameFrameworkVersion
        {
            get
            {
                return CmrGameFramework.Version.GameFrameworkVersion;
            }
        }
        ...
        public bool Save()
        {
            try
            {
                ...
                XmlElement xmlRoot = xmlDocument.CreateElement("CmrUnityFramework");
