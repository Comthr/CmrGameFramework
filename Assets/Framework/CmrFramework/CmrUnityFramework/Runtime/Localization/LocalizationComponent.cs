...
namespace CmrUnityFramework.Runtime
{
    ...
    [AddComponentMenu("CmrFramework/Localization")]
    public sealed class LocalizationComponent : GameFrameworkComponent
    {
        ...
        private void Start()
        {
            ...
            m_LocalizationManager.Language = baseComponent.EditorResourceMode && 
                baseComponent.EditorLanguage != Language.Unspecified ? baseComponent.EditorLanguage : m_LocalizationManager.SystemLanguage;
