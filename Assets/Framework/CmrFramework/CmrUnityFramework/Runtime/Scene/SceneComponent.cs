...
namespace CmrUnityFramework.Runtime
{
    ...
    [AddComponentMenu("CmrFramework/Scene")]
    public sealed class SceneComponent : GameFrameworkComponent
    {
        ...
        private void OnLoadSceneUpdate(object sender, CmrGameFramework.Scene.LoadSceneUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, LoadSceneUpdateEventArgs.Create(e));
        }

        private void OnLoadSceneDependencyAsset(object sender, CmrGameFramework.Scene.LoadSceneDependencyAssetEventArgs e)
        {
